...
describe('CollapsableMixin', function () {
  ...
  describe('getInitialState', function(){
    it('Should check defaultExpanded', function () {
      ...
      assert.ok(state.internalExpanded === true);
    });
  ...
  describe('from collapsed to expanded', function(){
    ...
    it('Should transition internalExpanded from false to true', function (done) {
      instance._addEndEventListener = function(node, complete){
        setTimeout(function(){
          complete();
          assert.ok(instance.state.internalExpanded);
          done();
        }, 100);
      };
      assert.ok(!instance.state.internalExpanded);
  ...
  describe('from expanded to collapsed', function(){
    ...
    it('Should transition internalExpanded from true to false', function (done) {
      instance._addEndEventListener = function(node, complete){
        setTimeout(function(){
          complete();
          assert.ok(!instance.state.internalExpanded);
